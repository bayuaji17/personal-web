...
import FormContact from "@/components/home-component/FormContact";
        ...
        <Card className="w-full p-4 min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card className="p-4 bg-secondary">
              <h2 className="text-2xl sm:text-4xl">{t("leftSide.title")}</h2>
              <p className="text-base">{t("leftSide.description")}</p>
              <ul className="space-y-4 sm:mt-2 xl:mt-10">
                <li className="flex gap-4 items-center">
                  <Mail className="size-6 sm:size-10" />
                  <div className="flex flex-col">
                    <span className="text-base sm:text-xl">Email</span>
                    <span className="text-sm sm:text-lg">
                      nugroho.bayuaji17@gmail.com
                    </span>
                  </div>
                </li>
                <li className="flex gap-4 items-center">
                  ...
                  <div className="flex flex-col">
                    ...
                    <Link
                      href={"https://github.com/bayuaji17"}
                      className="text-sm sm:text-lg"
                    >
                      github.com/bayuaji17
                    </Link>
                  </div>
                </li>
                <li className="flex gap-4 items-center">
                  ...
                  <div className="flex flex-col">
                    ...
                    <Link
                      ...
                      className="text-sm sm:text-lg"
                    >
                      linkedin.com/in/bayuajinugroho17
                    </Link>
                  </div>
                </li>
                <li className="flex gap-4 items-center">
                  <MapPinHouse className="size-6 sm:size-10" />
                  <div className="flex flex-col">
            ...
            {/* right side */}
            <Card className="bg-secondary p-4 gap-3.5 sm:gap-6">
              <h2 className="text-2xl sm:text-3xl font-bold sm:mb-4">
                {t("rightSide.title")}
              </h2>
              <p>{t("rightSide.description")}</p>
              <FormContact />
            </Card>
          </div>
        </Card>
